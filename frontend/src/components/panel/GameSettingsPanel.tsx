          ...
          <div className="mt-6 pt-6 border-t border-brand-200 dark:border-brand-700">
            <div className="flex items-center gap-2 mb-4">
              <input
                ...
                onChange={e => onChange({ ...formData, magpie_cropping_enabled: e.target.checked } as appconf.AppConfig)}
                className="w-4 h-4 rounded border-brand-300 dark:border-brand-600 text-brand-600 focus:ring-brand-500"
              />
              <label htmlFor="magpie-cropping-enabled" className="text-sm font-medium text-brand-700 dark:text-brand-300">
