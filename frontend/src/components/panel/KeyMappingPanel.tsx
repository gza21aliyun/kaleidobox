...
export function KeyMappingPanel({ gameId }: Ps4PanelProps) {
  ...
  const joyconMappings: KeyMapping[] = [
    ...
    { button: 'r', buttonLabel: 'R', mappingLabel: 'E', mappingKey: '', position: { x: 55, y: 15 } },
    ...
    { button: 'l3-left', buttonLabel: 'L-Stick Left', mappingLabel: '←', mappingKey: 'ArrowLeft', position: { x: 7, y: 40 } },
    { button: 'l3-up', buttonLabel: 'L-Stick Up', mappingLabel: '↑', mappingKey: 'ArrowUp', position: { x: 17, y: 30 } },
    { button: 'l3-right', buttonLabel: 'L-Stick Right', mappingLabel: '→', mappingKey: 'ArrowRight', position: { x: 25, y: 40 } },
    { button: 'l3-down', buttonLabel: 'L-Stick Down', mappingLabel: '↓', mappingKey: 'ArrowDown', position: { x: 17, y: 50 } },
    { button: 'r3-left', buttonLabel: 'R-Stick Left', mappingLabel: 'J', mappingKey: 'KeyJ', position: { x: 38, y: 60 } },
    { button: 'r3-up', buttonLabel: 'R-Stick Up', mappingLabel: 'I', mappingKey: 'KeyI', position: { x: 45, y: 50 } },
    { button: 'r3-right', buttonLabel: 'R-Stick Right', mappingLabel: 'L', mappingKey: 'KeyL', position: { x: 52, y: 60 } },
    { button: 'r3-down', buttonLabel: 'R-Stick Down', mappingLabel: 'K', mappingKey: 'KeyK', position: { x: 45, y: 70 } },
  ...
  const xinputMappings: KeyMapping[] = [
    ...
    { button: 'rb', buttonLabel: 'RB', mappingLabel: 'E', mappingKey: '', position: { x: 55, y: 12 } },
    ...
    { button: 'r3-left', buttonLabel: 'RS Left', mappingLabel: 'J', mappingKey: 'KeyJ', position: { x: 37, y: 53 } },
    { button: 'r3-up', buttonLabel: 'RS Up', mappingLabel: 'I', mappingKey: 'KeyI', position: { x: 45, y: 43 } },
    { button: 'r3-right', buttonLabel: 'RS Right', mappingLabel: 'L', mappingKey: 'KeyL', position: { x: 53, y: 53 } },
    { button: 'r3-down', buttonLabel: 'RS Down', mappingLabel: 'K', mappingKey: 'KeyK', position: { x: 45, y: 63 } },
